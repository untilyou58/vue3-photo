...
* ![Low][low_img] Mục này là **recommended** nhưng có thể bỏ qua trong một số tình huống cụ thể.

* ![Medium][medium_img] Mục này là **highly recommended** và có thể bỏ qua trong một số trường hợp thực sự cụ thể. Một vài yếu tố, nếu bỏ qua, có thể dẫn đến hậu quả tồi tệ cho hiệu suất hoặc SEO.

* ![High][high_img] Mục này là **Đéo thể bỏ qua** bằng bất cứ lí do nào. Bạn có thể dẫn đến một sự rối loạn chức năng trang của bạn hoặc có những vấn đề về truy cập hoặc SEO. Phần kiểm tra cần được làm trên những mục này đầu tiên.
...
* [ ] **Search Console:** ![Low][low_img] Search Console is installed and correctly configured. It is a free service offered by Google that helps you monitor, maintain, and troubleshoot your sites presence in Google Search results.
